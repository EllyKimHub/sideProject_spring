...
class UserControllerTest {
    /*
    ApplicationContext는 스프링 컨테이너에 구현체(인스턴스)이다.
    ...
    /*
    MockMvc는 실제 서블릿 켄테이너를 사용하지 않고 req,resp를 사용할 수있는 환경을 제공해준다.
    MockMvc객체를 만즐기 위해 필요한 것이 WebApplicationContext객체이다.
     */
