...
@Configuration
/*
스프링 컨테이너에 빈을 등록할 떄 사용하는 어노티션은 @Component이다.
빈을 등록하는 어노티션이 하나만 있는게 아니다.
그 중 하나가 @Configuration이다.
특별한 기능이 있는 것이 아니라 빈의 사용 목적을 구분짓기 위해 이름이 나워져있다.
...
//    이 객체를 불러와서 설정을 해 줄 수 있다.
    private final ApplicationContext applicationContext;
//    이 어노테이션은 외부파일의 설정 값들을 자바 객체로 가져올 때 사용한다.
//    스프링부트에서는 application.properties라는 파일에 설정 값을 전부 작성하기 떄문에
//    prefix는 어노테이션의 속성이다.
//    접두사를 설정할 때 사용한다.
